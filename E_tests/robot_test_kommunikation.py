...
class Doosan_robot():
    ...
    def send_worker(self, cmd_queue, s_getter, disconnect_event, stop_event):
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    send_thread = threading.Thread(target=self.send_worker, args=(globals()['cmd_queue'], s_getter, disconnect_event, send_stop), daemon=True)
                    send_thread.start()
