...
6. Coordinates and classifications are sent to the Doosan robot via TCP/IP.  
...
Full workflow (Google Docs):  
https://docs.google.com/document/d/1TSOkabhG66mFjT1kPjO0tYmKt7WV0dke9f8nmHOzbDQ/
